  ...
  <hr>
    ...
    <div class="container">
       <div class="row" >
           ...
           <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"> <h1> INTERNET</h1> <br>
Internet
...
The Internet is the global system of interconnected computer networks that use the Internet protocol suite (TCP/IP) to link devices worldwide. It is a network of networks that consists of private, public, academic, business, and government networks of local to global scope, linked by a broad array of electronic, wireless, and optical networking technologies. The Internet carries a vast range of information resources and services, such as the inter-linked hypertext documents and applications of the World Wide Web (WWW), electronic mail, telephony, and file sharing.
           ...
           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"> <img src="pics/bul.jpg" class="img-responsive"></div>  </div>  </div><!--con_close-->
     ...
     <div class="container">
      ...
      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><i class="fa fa-share" style="font-size:30px;color:black ; margin-top:30%;"></i></div>
    </div>
  </div>
...
The Internet is the global system of interconnected computer networks that use the Internet protocol suite (TCP/IP) to link devices worldwide. It is a network of networks that consists of private, public, academic, business, and government networks of local to global scope, linked by a broad array of electronic, wireless, and optical networking technologies. The Internet carries a vast range of information resources and services, such as the inter-linked hypertext documents and applications of the World Wide Web (WWW), electronic mail, telephony, and file sharing.
       ...
       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"> <img src="pics/bul.jpg" class="img-responsive"></div>
